      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-col justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            <h2 className="text-5xl font-bold">EasilyFamous</h2>
          </div>
          ...
          <div className="flex space-x-4">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              <svg className="w-5 h-5 text-[#d2e823] hover:text-[#3d1f58]" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        {/* Copyright */}
        <div className="text-center mt-6 text-[#d2e823]">
